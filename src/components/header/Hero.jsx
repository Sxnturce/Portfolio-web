        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 h-full  gap-0 sm:gap-12  md:gap-12 lg:gap-4 md:place-content-center">
          <section className="flex flex-col gap-5 ms:gap-8 justify-end md:justify-center relative z-[5] lg:px-4">
            ...
            <p className="text-[0.95rem] md:text-lg lg:text-left text-center animate-fade-right dark:text-color-smoke-high">
              A Software Engineering student from Peru, training to become a full-stack
              developer. Passionate about creating and designing scalable, reusable code
              to address business and personal challenges.
            </p>
            <div className="flex gap-8 justify-center lg:justify-normal">
              <Link type="download" msg={"Download CV"} />
              <Link type="github" msg={"Github"} url={"https://github.com/Sxnturce"} />
            </div>
          </section>
